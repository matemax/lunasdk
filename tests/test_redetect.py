...
class TestDetector(BaseTestClass):
    ...
    def test_redetect_one_with_one_face(self):
        for subTest, detector, score in self.detectorSubTest():
            with subTest:
                ...
                for optionDetect in ("bBox", "detection"):
                    ...
                    self.assertDetectionTrue(redetect, [VLIMAGE_ONE_FACE])
            ...
            with subTest:
                ...
                redetect = detector.redetect(images=[ImageForRedetection(image=VLIMAGE_SEVERAL_FACE,
                                                     ...
                                                     ImageForRedetection(image=VLIMAGE_ONE_FACE,
                                                                         bBoxes=[detectOne.boundingBox.rect])])
                self.assertDetectionTrue(redetect, [VLIMAGE_ONE_FACE, VLIMAGE_SEVERAL_FACE])
